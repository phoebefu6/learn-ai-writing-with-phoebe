...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    var m = mx || crumb.textContent.match(/Writer session (\d+) of 10/);
    if (m) {
      var current = parseInt(m[1], 10);
      var pages = mx
        ? ["a1-what-changed.html", "a2-reading-ai-writing.html", "a3-house-voice.html", "a4-disclosure-and-trust.html", "a5-team-writing-standard.html", "a6-raising-the-bar.html"]
        : ["b1-writers-ai-loop.html", "b2-the-writing-brief.html", "b3-your-voice-captured.html", "b4-emails-and-messages.html", "b5-updates-and-memos.html", "b6-clarity-lab.html", "b7-editing.html", "b8-difficult-writing.html", "b9-long-form.html", "b10-capstone-week.html"];
